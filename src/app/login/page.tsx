...
import { useAuth } from "@/contexts/auth-context"; // ajuste este path para o seu
    ...
    <form className={cn("flex flex-col gap-6", className)} onSubmit={handleLogin} {...props}>
      ...
      <div className="grid gap-6">
        <div className="grid gap-3">
          <Label htmlFor="email" className="text-gray-700 text-base">E-mail</Label>
          <Input
            id="email"
            name="email"
            type="email"
            ...
            className={`bg-[#f9f9f9] border ${
              emailError ? "border-red-500" : "border-gray-300 focus:border-[#09bc8a]"
        ...
        <div className="grid gap-3">
          <div className="flex items-center">
            <Label htmlFor="password" className="text-gray-700 text-base">Senha</Label>
            <Link
              href="/password"
  ...
  return (
    <>
      <div className="fixed inset-0 -z-10 lg:hidden">
        <img src="/img/fundo-cadastro.jpg" alt="Imagem de fundo" className="h-full w-full object-cover" />
